...
import runCrewLeaderboardRouter from './routes/RunCrew/runCrewLeaderboardRoute.js';
// Training routes
...
app.use('/api/runcrew', runCrewLeaderboardRouter); // /:runCrewId/leaderboard (more specific, must come before /:id)
